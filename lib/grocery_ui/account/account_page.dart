...
class GroceryAccountPage extends StatefulWidget {
  @override
  _GroceryAccountPageState createState() => _GroceryAccountPageState();
}

class _GroceryAccountPageState extends State<GroceryAccountPage> {
  @override
              ...
              children: [
                if(model.blocks.settings.socialLink.facebook.isNotEmpty)
                  IconButton(
                    ...
                    onPressed: (){
                      launchUrl(Uri.parse(model.blocks.settings.socialLink.facebook));
                    },
                  ),
                if(model.blocks.settings.socialLink.twitter.isNotEmpty)
                  IconButton(
                    ...
                    onPressed: () {
                      launchUrl(Uri.parse(model.blocks.settings.socialLink.twitter));
                    },
                  ),
                if(model.blocks.settings.socialLink.linkedIn.isNotEmpty)
                  IconButton(
                    ...
                    onPressed: () {
                      launchUrl(Uri.parse(model.blocks.settings.socialLink.linkedIn));
                    },
                  ),
                if(model.blocks.settings.socialLink.instagram.isNotEmpty)
                  IconButton(
                    ...
                    onPressed: () {
                      launchUrl(Uri.parse(model.blocks.settings.socialLink.instagram));
                    },
                  ),
                if(model.blocks.settings.socialLink.whatsapp.isNotEmpty)
                  IconButton(
                    ...
                    onPressed: () {
                      print(model.blocks.settings.socialLink.whatsapp);
                      launchUrl(Uri.parse(model.blocks.settings.socialLink.whatsapp));
                    },
                  )
              ],
            ),
