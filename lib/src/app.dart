...
import 'package:app/grocery_ui/cart/cart.dart';
import 'package:app/grocery_ui/home.dart';
...
import 'ui/accounts/orders/booking_page.dart';
    ...
    if(bottomItemsLength < 2) {
      ...
      widget.appStateModel.blocks.settings.bottomNavigationBar.items.forEach((element) {
        if(element.link == 'home') {
          ...
          _children.add(Search(hideBackButton: true));
        } else if(element.link == 'bookings') {
          _children.add(BookingPage());
