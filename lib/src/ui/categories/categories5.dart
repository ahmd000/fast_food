...
class _Categories5State extends State<Categories5> {
                        ...
                        child: Container(
                          ...
                          child: Container(
                            ...
                            child: GridView.builder(
                                ...
                                itemBuilder: (BuildContext ctxt, int index) {
                                  return Container(
                                      child: CategoryItem(subCategories[index], index, snapshot.categories, context));
                                }),
                          ),
                        ))
  ...
  Widget CategoryItem(Category category, int i, List<Category> categories, BuildContext context) {
    return InkWell(
      onTap: () {
        onCategoryClick(selectedCategory, context);
        /*var filter = new Map<String, dynamic>();
