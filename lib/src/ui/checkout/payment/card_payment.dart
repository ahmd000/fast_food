  ...
  Future<void> _processNuveiCardPayment() async {
    ...
    if(_card != null && _card!.complete) {
      if(widget.checkoutFormBloc.formData['billing_last_name'] != null) {
        widget.checkoutFormBloc.formData['nuvei-card-name'] = widget.checkoutFormBloc.formData['billing_last_name']!;
      ...
      widget.checkoutFormBloc.formData['nuvei-card-expiry'] = _card!.expiryMonth!.toString() + ' / '+ _card!.expiryYear!.toString();
      widget.checkoutFormBloc.formData['nuvei-card-cvc'] = _card!.cvc!;
      widget.checkoutFormBloc.formData['card-number'] = _card!.number!;//'4444 3333 2222 1111';
      widget.checkoutFormBloc.formData['card-expiry'] = _card!.expiryMonth!.toString() + _card!.expiryYear!.toString();
      widget.checkoutFormBloc.formData['cvc'] = _card!.cvc!;

      //print(widget.checkoutFormBloc.formData);
//print(widget.checkoutFormBloc.formData);
