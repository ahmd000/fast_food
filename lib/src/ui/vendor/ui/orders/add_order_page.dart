...
class _AddOrderPageState extends State<AddOrderPage> {
  ...
  void initState() {
    ...
    widget.order.billing = Address(firstName: '', lastName: '', company: '', address1: '', address2: '', city: '', postcode: '', country: '', state: '', email: '', phone: '');
    widget.order.shipping = Address(firstName: '', lastName: '', company: '', address1: '', address2: '', city: '', postcode: '', country: '', state: '', email: '', phone: '');
  }
