...
import '../../../../../grocery_ui/blocks/blocks.dart';
...
class _StoreHomeState extends State<StoreHome> with TickerProviderStateMixin {
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    for (var i = 0; i < snapshot.data!.blocks.length; i++)
                      SliverBlock(block: snapshot.data!.blocks[i], vendorHome: true, vendorCategories: snapshot.data!.categories),
                      ...
                      SliverGrid(
                          ...
                          delegate: SliverChildBuilderDelegate(
                              ...
                              return Center(
                                child: SizedBox(
                                    width: 108,
                                    child: SingleProduct(product: snapshot.data!.products[index])
                                ),
                              );
                            },
  ...
  buildLisOfBlocks(StoreDetails snapshot) {
    List<Widget> list = [];
    ...
    list.add(buildRecentProductGridList(snapshot.products));
            ...
            delegate: SliverChildListDelegate([
              Container(
                  ...
                  child: StreamBuilder<StoreDetails>(
                      stream: widget.storeHomeBloc.storeDetails,
                      builder: (context, snapshot) {
                        if (widget.storeHomeBloc.hasMoreItems) {
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                hintText: appStateModel.blocks.localeText.searchFor,
                fillColor: fillColor,
                filled: true,
                border: border,
